...
public class PortugalManager : MonoBehaviour
{
    ...
    public void UpdateGameProgress()
    {
        ...
        {
            historyScoreText.text = GData.Room[5].HisQ[0].AnswerGiven + "/3";
            geographyScoreText.text = GData.Room[5].GeoQ[0].AnswerGiven + "/3";
            foodScoreText.text = GData.Room[5].FoodQ[0].AnswerGiven + "/3";
            cultureScoreText.text = GData.Room[5].CulQ[0].AnswerGiven + "/3";
            if (GData.Room[5].No_Of_Obj_Complete < 4)
            {
                if (GData.Room[5].HisQ[0].AnswerGiven >= GData.Room[5].HisQ[0].TotalQuestion)
                {
                    if (!GData.Room[5].HisQ[0].IsComplte)
                    {
                        GData.Room[5].HisQ[0].IsComplte = true;
                        GData.Room[5].No_Of_Obj_Complete++;
                ...
                if (GData.Room[5].GeoQ[0].AnswerGiven >= GData.Room[5].GeoQ[0].TotalQuestion)
                {
                    if (!GData.Room[5].GeoQ[0].IsComplte)
                    {
                        GData.Room[5].GeoQ[0].IsComplte = true;
                        GData.Room[5].No_Of_Obj_Complete++;
                        PersistentDataManager.instance.SaveData();
                        geographyCompleteImage.SetActive(true);
                    }
                ...
                if (GData.Room[5].FoodQ[0].AnswerGiven >= GData.Room[5].FoodQ[0].TotalQuestion)
                {
                    if (!GData.Room[5].FoodQ[0].IsComplte)
                    {
                        GData.Room[5].FoodQ[0].IsComplte = true;
                        GData.Room[5].No_Of_Obj_Complete++;
                        PersistentDataManager.instance.SaveData();
                        foodCompleteImage.SetActive(true);
                    }
                ...
                if (GData.Room[5].CulQ[0].AnswerGiven >= GData.Room[5].CulQ[0].TotalQuestion)
                {
                    if (!GData.Room[5].CulQ[0].IsComplte)
                    {
                        GData.Room[5].CulQ[0].IsComplte = true;
                        GData.Room[5].No_Of_Obj_Complete++;
                        PersistentDataManager.instance.SaveData();
                        cultureCompleteImage.SetActive(true);
                    }
    ...
    {
        if (PlayerPrefs.GetInt("POMscore") >= 30)
        {
            RoomCompleteParticleEffect.SetActive(true);
        }
        else
        {
            ...
            {
                case 0:
                    ShowScore.text = $"Your Score is {PlayerPrefs.GetInt("POMscore")}" + " / 60";
                    break;
                case 1:
                    ShowScore.text = $"Το σκορ σου είναι {PlayerPrefs.GetInt("POMscore")}" + " / 60";
                    break;
                case 2:
                    ShowScore.text = $"Twój wynik to {PlayerPrefs.GetInt("POMscore")}" + " / 60";
                    break;
            }
        }
    }
    ...
    public void SetHistoryQuizData(int index)
    {
        ...
        historyQuestonText.text = historyQues[GData.PRhistoryQuizIndex];

        historyOptionTexts[0].text = histOp1[GData.PRhistoryQuizIndex].answer;
        historyOptionTexts[1].text = histOp2[GData.PRhistoryQuizIndex].answer;

        //setting style
        //SetTextStyle(historyOptionTexts[0], historyOptionTexts[1]);

        if (historyAns[GData.PRhistoryQuizIndex] == 0)
        {
            historyFinalAnswer = histOp1[GData.PRhistoryQuizIndex].answer;
        }
        else if (historyAns[GData.PRhistoryQuizIndex] == 1)
        {
            historyFinalAnswer = histOp2[GData.PRhistoryQuizIndex].answer;
        }
    ...
    public void SetGeographyQuizData(int index)
    {
        ...
        geographyQuestonText.text = geographyQues[GData.PRgeographyQuizIndex];

        geographyOptionTexts[0].text = geogOp1[GData.PRgeographyQuizIndex].answer;
        geographyOptionTexts[1].text = geogOp2[GData.PRgeographyQuizIndex].answer;

        //setting style
        //SetTextStyle(geographyOptionTexts[0], geographyOptionTexts[1]);

        if (geographyAns[GData.PRgeographyQuizIndex] == 0)
        {
            geographyFinalAnswer = geogOp1[GData.PRgeographyQuizIndex].answer;
        }
        else if (geographyAns[GData.PRgeographyQuizIndex] == 1)
        {
            geographyFinalAnswer = geogOp2[GData.PRgeographyQuizIndex].answer;
        }
    ...
    public void SetFoodQuizData(int index)
    {
        ...
        foodQuestonText.text = foodQues[GData.PRfoodQuizIndex];

        foodOptionTexts[0].text = foodOp1[GData.PRfoodQuizIndex].answer;
        foodOptionTexts[1].text = foodOp2[GData.PRfoodQuizIndex].answer;

        //setting style
        //SetTextStyle(foodOptionTexts[0], foodOptionTexts[1]);

        if (foodAns[GData.PRfoodQuizIndex] == 0)
        {
            foodFinalAnswer = foodOp1[GData.PRfoodQuizIndex].answer;
        }
        else if (foodAns[GData.PRfoodQuizIndex] == 1)
        {
            foodFinalAnswer = foodOp2[GData.PRfoodQuizIndex].answer;
        }
    ...
    public void SetCultureQuizData(int index)
    {
        ...
        cultureQuestonText.text = cultureQues[GData.PRcultureQuizIndex];

        cultureOptionTexts[0].text = culOp1[GData.PRcultureQuizIndex].answer;
        cultureOptionTexts[1].text = culOp2[GData.PRcultureQuizIndex].answer;

        //setting style
        //SetTextStyle(cultureOptionTexts[0], cultureOptionTexts[1]);

        if (cultureAns[GData.PRcultureQuizIndex] == 0)
        {
            cultureFinalAnswer = culOp1[GData.PRcultureQuizIndex].answer;
        }
        else if (cultureAns[GData.PRcultureQuizIndex] == 1)
        {
            cultureFinalAnswer = culOp2[GData.PRcultureQuizIndex].answer;
        }
    ...
    public void ResetQuestionaPanel()
    {
        ...
        if (PlayerPrefs.GetInt("levelcurrent") == 6)
        {
            ...
            {
                if (selectedCategory == 1 && GData.Room[5].HisQ[0].AnswerGiven < 3)
                {
                    SetHistoryQuizData(1);
                    levelFailPanel.SetActive(false);
                    quizPanel.SetActive(true);
                }
                else if (selectedCategory == 2 && GData.Room[5].GeoQ[0].AnswerGiven < 3)
                {
                    SetGeographyQuizData(2);
                    levelFailPanel.SetActive(false);
                    quizPanel.SetActive(true);
                }
                else if (selectedCategory == 3 && GData.Room[5].FoodQ[0].AnswerGiven < 3)
                {
                    SetFoodQuizData(3);
                    levelFailPanel.SetActive(false);
                    quizPanel.SetActive(true);
                }
                else if (selectedCategory == 4 && GData.Room[5].CulQ[0].AnswerGiven < 3)
                {
                    SetCultureQuizData(4);
                    levelFailPanel.SetActive(false);
                    quizPanel.SetActive(true);
    ...
    public void AnswerBtnClick(Text text)
    {
        ...
        if (PlayerPrefs.GetInt("levelcurrent") == 6)
        {
            ...
            {
                GData.PRhistoryQuizIndex = (GData.PRhistoryQuizIndex + 1) % historyQues.Length;
                PersistentDataManager.instance.SaveData();
            ...
            {
                GData.PRgeographyQuizIndex = (GData.PRgeographyQuizIndex + 1) % geographyQues.Length;
                PersistentDataManager.instance.SaveData();
            ...
            {
                GData.PRfoodQuizIndex = (GData.PRfoodQuizIndex + 1) % foodQues.Length;
                PersistentDataManager.instance.SaveData();
            ...
            {
                GData.PRcultureQuizIndex = (GData.PRcultureQuizIndex + 1) % cultureQues.Length;
                PersistentDataManager.instance.SaveData();
    ...
    public void RightAnswerHandler()
    {
        ...
        {
            //PlayerPrefs.SetInt("POMscore", PlayerPrefs.GetInt("POMscore") + 5);
        }
    }
    ...
    IEnumerator CorrectAnswerWait()
    {
        ...
        if (!GameManager.Instance.IsMulti)
        {
            if (selectedCategory == 1)
            {
                if (PlayerPrefs.GetInt("PortugalHist", 0) < 3)
                {
                    ...
                    {
                        PlayerPrefs.SetInt("Level6", PlayerPrefs.GetInt("Level6") + 1);
                        PlayerPrefs.Save();
                        ...
                        LevelCompleteText.text = PlayerPrefs.GetInt("POMscore").ToString();
        ...
        else
        {
            if (selectedCategory == 1)
            {
                if (GData.Room[5].HisQ[0].AnswerGiven < 3)
                {
                    GData.Room[5].HisQ[0].AnswerGiven++;
                    PersistentDataManager.instance.SaveData();
                    if (GData.Room[5].HisQ[0].AnswerGiven < 3)
                    {
                        SetHistoryQuizData(1);
                    }
                    else if (GData.Room[5].HisQ[0].AnswerGiven == 3)
                    {
            ...
            {
                if (GData.Room[5].GeoQ[0].AnswerGiven < 3)
                {
                    GData.Room[5].GeoQ[0].AnswerGiven++;

                    if (GData.Room[5].GeoQ[0].AnswerGiven < 3)
                    {
                        SetGeographyQuizData(2);
                    }
                    else if (GData.Room[5].GeoQ[0].AnswerGiven == 3)
                    {
                        OnMultiplayerObjComplete();
                        ReadQuestion.interactable = false;
                    }
            ...
            {
                if (GData.Room[5].FoodQ[0].AnswerGiven < 3)
                {
                    GData.Room[5].FoodQ[0].AnswerGiven++;
                    PersistentDataManager.instance.SaveData();
                    ...
                    else if (GData.Room[5].FoodQ[0].AnswerGiven == 3)
                    {
                        ReadQuestion.interactable = false;
                        OnMultiplayerObjComplete();
                    }
            ...
            {
                if (GData.Room[5].CulQ[0].AnswerGiven < 3)
                {
                    GData.Room[5].CulQ[0].AnswerGiven++;
                    PersistentDataManager.instance.SaveData();
                    ...
                    else if (GData.Room[5].CulQ[0].AnswerGiven == 3)
                    {
                        OnMultiplayerObjComplete();
                        ReadQuestion.interactable = false;
                    }
